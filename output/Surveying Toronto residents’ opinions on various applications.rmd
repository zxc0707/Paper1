...
thanks: "Code and data are available at https://github.com/zxc0707/Paper1.git"
...
filtered_data2 %>%
  slice(1:10) %>%
  kable(
    caption = "Selecting first 10 rows of part of required columns from the residents'opinions dataset",
col.names=c("BALLOTS_SPOILED", "BALLOTS_DISTRIBUTED", "OPEN_DATE", "CLOSE_DATE"),
linesep = "", digits = 1, booktabs=TRUE) %>%
  kable_styling(latex_options = "HOLD_position", font_size = 10)
```

Table 1 shows the first 10 rows of the resident opinion data set. It should be noted that I used more than these 4 columns in this report. The data information represented by each column is explained in detail below by listing them one by one.
