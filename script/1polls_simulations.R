#I want to simulate a dataset which includes  7 columns:"APPLICATION_FOR“, ”BALLOTS_BLANK“, ”BALLOTS_IN_FAVOUR”，“BLLOTS_OPPOSED","OPEN_DATE", "CLOSE_DATE", "FINAL_VOTER_COUNT" and 1235 rows with random entries.
